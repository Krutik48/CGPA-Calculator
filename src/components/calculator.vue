    ...
    <div class="d-flex flex-column justify-content-center align-items-center">
        ...
        <table>
            ...
            <tbody>
                <tr v-for="(course, index) in courses" :key="course.name">
                    ...
                    <td>
                        ...
                        <form v-if="editing === index" @submit.prevent="saveEdit(index)">
                            ...
                            <button class="btn btn-outline-dark editBtn" type="submit">
                                <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor" class="bi bi-check-lg" viewBox="0 0 16 16">
                    ...
                    <td>
                        <button class="btn btn-outline-danger" @click="deleteCourse(index)">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3 icn" viewBox="0 0 16 16">
                        ...
                        <button class="btn btn-outline-dark mx-1" @click="startEdit(index)" v-if="editing !== index">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square icn" viewBox="0 0 16 16">
                ...
                <tr>
                    <td>
                        <input type="text" v-model="course.no"  class="form-control" placeholder="Course No" list="courseNolist" v-on:input="onAddCourseNo" />
                            <datalist id="courseNolist">
                                <option v-for="(course,index) in courseData" :key="index" :value="course.course_no" :id ="index"/>
                            </datalist>
                    </td>
                    <td>
                        <input type="text" v-model="course.name" class="form-control" placeholder="Course Name" list="courseNameList" v-on:input="onClickCourseName"/>
                    ...
                    <td>
                        <button type="submit" class="btn btn-dark my-2" style="display: table-cell;">Add Course</button>
                    </td>
                </tr>
            </tbody>
        </table>
